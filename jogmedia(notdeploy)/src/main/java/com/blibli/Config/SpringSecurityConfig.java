...
//    private BCryptPasswordEncoder bCryptPasswordEncoder;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.authorizeRequests()
                ...
                .antMatchers("/home/**","/", "/book/**", "/category/**", "/discount/**", "/emptyStok/**", "/report/**",
                        "/report/**", "/report-detail/**", "/report-month/**", "/report-year/**", "/tampilemp/**", "/store/**",
                        "/createBook/**", "/createCategory/**","/createEmployee/**","/createStore/**")
